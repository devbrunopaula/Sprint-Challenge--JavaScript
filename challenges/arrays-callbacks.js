...
**** Can be done all in one line, but the instructions says to create a new Array.
*/ 


const lowCaseAnimalNames = []
  zooAnimals.map( el => lowCaseAnimalNames.push( el.animal_name.toLocaleLowerCase() ))
...
//     return cb(a,b)
//   }else {
//     return `The third argument need to be a callback function.`
//   }
// }
